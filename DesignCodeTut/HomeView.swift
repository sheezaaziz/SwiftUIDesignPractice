...
struct HomeView: View {
    ...
    var body: some View {
        VStack {
            ...
            SectionView(section: sectionData[2], width: screen.height - 60, height: 275)
...
struct SectionView: View {
    ...
    var body: some View {
        ...
        .cornerRadius(30)
        .shadow(color: section.color.opacity(0.3), radius: 20, x: 0.0, y: 20)
    }
}
...
let sectionData = [
    ...
    Section(title: "Build a SwiftUI app", text: "20 Sections", logo: "Logo1", image: Image(uiImage: #imageLiteral(resourceName: "Card4")), color: Color(#colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1))),
    Section(title: "Advanced SwiftUI", text: "24 Sections", logo: "Logo1", image: Image(uiImage: #imageLiteral(resourceName: "Card3")), color: Color(#colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1))),
]
